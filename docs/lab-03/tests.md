...
| API-05 | API | AC-09–10 | Claim race, assignment, IT Priority, transitions, comments, notes, attachments | `server/tests/lab-03/staff-ticket-detail.api.test.ts` | Implemented on Issue #39 response branch; pending merge |
...
| UI-04 | UI/security | AC-09–10 | Staff detail ownership/workflow/comments/notes/attachments and privacy | `client/tests/lab-03/StaffTicketDetail.test.tsx` | Implemented on Issue #39 response branch; pending merge |
...
| E2E-02 | E2E | AC-08–10 | Staff queue search/filters/page, claim, status, priority, public comment, internal note | `client/e2e/lab-03/staff-queue.spec.ts`, `client/e2e/lab-03/staff-ticket-flow.spec.ts` | Implemented on Issue #39 response branch; pending merge |
