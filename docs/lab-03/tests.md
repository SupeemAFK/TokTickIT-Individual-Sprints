...
| API-05 | API | AC-09–10 | Claim race, assignment, IT Priority, transitions, comments, notes, attachments | `server/tests/lab-03/staff-ticket-detail.api.test.ts` | Implemented on PR #55; merged |
| API-06 | API/security | AC-11–12, AC-17 | Admin list/search/role filter/create/edit/activation/reset, final-admin safeguards, and owner integrity for active, inactive, and CLOSED-ticket owners | `server/tests/lab-03/users-admin.api.test.ts` | Implemented on Issue #40 response branch; pending merge |
...
| UI-04 | UI/security | AC-09–10 | Staff detail ownership/workflow/comments/notes/attachments and privacy | `client/tests/lab-03/StaffTicketDetail.test.tsx` | Implemented on PR #55; merged |
| UI-05 | UI/responsive | AC-11–12 | Admin search/list/create/edit/activation/role/reset and safeguards | `client/tests/lab-03/UserManagement.test.tsx` | Implemented on Issue #40 response branch; pending merge |
...
| E2E-02 | E2E | AC-09–10 | Staff ticket detail claim, status, IT Priority, Public Comment, Internal Note, existing attachment action, and responsive detail behavior | `client/e2e/lab-03/staff-ticket-flow.spec.ts` | Implemented on PR #55; merged |
| E2E-03 | E2E | AC-11–12 | Admin search/create/edit/activation/reset and forbidden non-admin access | `client/e2e/lab-03/user-administration.spec.ts` | Implemented on Issue #40 response branch; pending merge |
